"""setup1_v2b_2h.py — v2.b trigger test: 2019-01-01 sampai sekarang, 2H TF.
...
sys.path.insert(0, "/home/ubuntu/trading-research/backtests/BTCUSDT/SETUP1/2H")
...
# fetch
CACHE=os.path.join(HERE,"data_BTCUSDT_2h_2019now.csv")
...
print(f"[*] loading BTCUSDT 2h 2019..now")
...
# ── RUN BACKTEST ──
print(f"\n{'='*80}")
print(f"SETUP1 v2.b BACKTEST 2H — 2019-01-01 to {END.strftime('%Y-%m-%d')}")
