...
# ---------- SMI 3-step (precompute all bars once) ----------
print("[SMI] precomputing state per bar...")
smi_state = [None]*len(close)
for i in range(2, len(close)):
    smi_state[i] = smi_pro.smi_pro_v3(df.iloc[:i+1], SMI_CFG)["bar_state"]
print("[SMI] done precompute")
...
with open("/home/ubuntu/trading-research/setup1_4h_journal.csv","w",newline="") as f:
...
print(f"[JOURNAL] wrote {len(TRADE_DETAIL)} trades -> setup1_4h_journal.csv")
