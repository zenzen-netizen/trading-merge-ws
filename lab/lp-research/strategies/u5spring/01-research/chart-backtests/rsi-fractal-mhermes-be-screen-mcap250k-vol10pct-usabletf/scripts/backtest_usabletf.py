...
def md_report(summary: list[dict[str, Any]], trades: list[dict[str, Any]], data_counts: list[dict[str, Any]]) -> str:
    lines = []
    lines.append("# RSI(2) + Fractal(3) Backtest — Meteora SOL Pools (Usable TF Only + MCAP250k + Vol10pct)")
    lines.append("")
    ...
    lines.append("Timeframe scope for this run: usable TF only -> 1m, 5m, 15m. 30m intentionally excluded from verdict.")
    lines.append("")
