...
- `BE1` menang `38 / 58` family best
- `BE50` menang `13 / 58`
- `BE75` menang `4 / 58`
- `TP_FRACTAL` menang `3 / 58`
...
- `1m`: 22 family, 10 positif, median best `-0.234`
- `5m`: 18 family, 11 positif, median best `+0.300`
- `15m`: 18 family, 8 positif, median best `-0.159`
...
- `O1_SL50`: 17 / 29 family best positif
- `O2_ST2X`: 12 / 29 family best positif

Tapi head-to-head winner count:
- overall: `O2` menang 16, `O1` menang 12, tie 1
- khusus `5m`: `O2` menang 6, `O1` menang 3
